...
class Trainer:
    ...
    def Evaluation_Step(self, tokens, token_lengths, features, feature_lengths, audios, audio_lengths):
        ...
        return predictions, noises, epsilons, log_duration_predictions, means_p, log_stds_p, durations
    ...
    def Evaluation_Epoch(self):
        ...
        for step, (tokens, token_lengths, features, feature_lengths, audios, audio_lengths) in tqdm(
            ...
            predictions, noises, epsilons, log_duration_predictions, means_p, log_stds_p, durations = self.Evaluation_Step(
                tokens= tokens,
                token_lengths= token_lengths,
                features= features,
                feature_lengths= feature_lengths,
